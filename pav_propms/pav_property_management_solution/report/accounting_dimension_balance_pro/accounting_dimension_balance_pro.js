...
frappe.query_reports["Accounting Dimension Balance Pro"] = {
	"filters": [
		{
			fieldname: "company",
			label: __("Company"),
		...
		},
		{
			...
			fieldtype: "Select",
			options: ["Cost Center", "Project", "Project Activities", "Property"],
			default: "Cost Center",
			reqd: 1,
			on_change: function () {
...
erpnext.dimension_filters.forEach((dimension) => {
	frappe.query_reports["Accounting Dimension Balance Pro"].filters[4].options.push(dimension["document_type"]);
});
